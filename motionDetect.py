...
mqttBrokerAddr = "192.168.1.176" # the IP address / DNS name of your MQTT broker
mqttBrokerPort = 1883 # the port of your MQTT broker
mqttUser = "" # fill in the blank
mqttPass = "" # fill in the blank
mqttTopic = "home/bedroom/pi/motion"
